...
@Controller
@RequestMapping("main3") // 모든 메소드의 앞 부분에 적용
public class Controller03 {
    ...
    // /main3/sub5?address=seoul&age=44&emal=gmail&home=dokdo&city=seoul&name=donald
    @RequestMapping("sub5")
    ...
    public void sub6(MyBean031 params) {
        ...
        System.out.println("params.get어드레스() = " + params.getAddress());
    }
